namespace GL.Servers.Library.LZMA.Common
{
    using System;
    ...
    public class SwitchForm
    {
        ...
        public SwitchForm(string idString, SwitchType type, bool multi, int minLen) : this(idString, type, multi, minLen, 0, string.Empty)
        {
        }
