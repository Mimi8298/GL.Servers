namespace GL.Servers.Core.Consoles.Colorful
{
    ...
    public sealed class StyledString : IEquatable<StyledString>
    {
        ...
        {
            this.AbstractValue = oneDimensionalRepresentation;
        }

        public StyledString(string oneDimensionalRepresentation, string twoDimensionalRepresentation)
        {
            this.AbstractValue = oneDimensionalRepresentation;
            this.ConcreteValue = twoDimensionalRepresentation;
        }
        ...
        public override int GetHashCode()
        {
            ...
            hash *= 79 + this.AbstractValue.GetHashCode();
            hash *= 79 + this.ConcreteValue.GetHashCode();
