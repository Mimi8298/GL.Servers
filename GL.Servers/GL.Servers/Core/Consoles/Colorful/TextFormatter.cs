namespace GL.Servers.Core.Consoles.Colorful
{
    ...
    public sealed class TextFormatter
    {
        ...
        public TextFormatter(Color defaultColor)
        {
            ...
            this.textPattern = new TextPattern(this.defaultFormatToken);
        }
        ...
        public List<KeyValuePair<string, Color>> GetFormatMap(string input, object[] args, Color[] colors)
        {
            ...
            List<MatchLocation> locations = this.textPattern.GetMatches(input).ToList();

            this.TryExtendColors(ref args, ref colors);
