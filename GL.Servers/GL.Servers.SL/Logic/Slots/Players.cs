namespace GL.Servers.SL.Logic.Slots
{
    ...
    using GL.Servers.SL.Extensions.Json;
    ...
    internal class Players : ConcurrentDictionary<long, Player>
    {
        ...
        internal Players()
        {
            ...
            else if (Constants.Database == DBMS.MySQL || Constants.Database == DBMS.Both)
            {
        ...
        /* internal Player FindPlayer(Expression<Func<Core.Database.Models.Mongo.Players, bool>> Filters)
        {
