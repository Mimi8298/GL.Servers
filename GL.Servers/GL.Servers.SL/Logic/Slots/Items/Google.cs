namespace GL.Servers.SL.Logic.Slots.Items
{
    using System.IO;
    ...
    internal class Google
    {
        ...
        internal void GetCredentials()
        {
            using (var Stream = new FileStream("client_secret.json", FileMode.Open, FileAccess.Read))
            {
                ...
                }, "GL.Servers.SL", CancellationToken.None, new FileDataStore("GL.Servers.SL")).Result;
            }
        }
        ...
        internal void Login()
        {
            ...
            {
                HttpClientInitializer = this.OCredentials, ApplicationName = "GL.Servers.SL", ApiKey = "AIzaSyAr6oXL0O52iM2y3qx_1edjLls4LAAows8"
            });
        }
