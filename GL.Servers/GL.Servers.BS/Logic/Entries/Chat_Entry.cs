namespace GL.Servers.BS.Logic.Entries
{
    ...
    internal class Chat_Entry : IEntry
    {
        /// <summary>
        ...
        public Stream_Type Type
        {
            get
            {
                return Stream_Type.CHAT;
            }
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="Chat_Entry"/> class.
        /// </summary>
        internal Chat_Entry()
        {
        ...
        internal Chat_Entry(Member Member) : this()
        {
            if (Member != null)
            {
