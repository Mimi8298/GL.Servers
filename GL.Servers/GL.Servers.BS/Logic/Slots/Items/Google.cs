    ...
    internal class Google
    {
        ...
        internal void GetCredentials()
        {
            using (var Stream = new FileStream("client_secret.json", FileMode.Open, FileAccess.Read))
            {
                ...
                }, "GL.Servers.BS", CancellationToken.None, new FileDataStore("GL.Servers.BS")).Result;
            }
        }
        ...
        internal void Login()
        {
            ...
            {
                HttpClientInitializer = this.OCredentials, ApplicationName = "GL.Servers.BS", ApiKey = "AIzaSyAr6oXL0O52iM2y3qx_1edjLls4LAAows8"
            });
        }
