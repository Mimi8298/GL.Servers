namespace GL.Servers.BS.Packets.Messages.Server
{
    ...
    internal class Top_Global_Clans_Data : Message
    {
        private IEnumerable<Clan> Clans;

        /// <summary>
        /// Initializes a new instance of the <see cref="Top_Global_Clans_Data"/> class.
        /// </summary>
        /// <param name="Device">The device.</param>
        public Top_Global_Clans_Data(Device Device, IEnumerable<Clan> Clans) : base(Device)
        {
