namespace GL.Servers.BS.Packets.Messages.Server
{
    ...
    internal class Top_Local_Players_Data : Message
    {
        private IEnumerable<Player> Players;

        /// <summary>
        /// Initializes a new instance of the <see cref="Top_Local_Players_Data"/> class.
        /// </summary>
        /// <param name="Device">The device.</param>
        public Top_Local_Players_Data(Device Device, IEnumerable<Player> Players) : base(Device)
        {
