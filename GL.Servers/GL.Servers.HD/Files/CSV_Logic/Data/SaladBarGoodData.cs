namespace GL.Servers.HD.Files.CSV_Logic.Data
{
    ...
    internal class SaladBarGoodData : Data
    {
		/// <summary>
        /// Initializes a new instance of the <see cref="SaladBarGoodData"/> class.
        /// </summary>
        /// <param name="Row">The row.</param>
        /// <param name="DataTable">The data table.</param>
        public SaladBarGoodData(Row Row, DataTable DataTable) : base(Row, DataTable)
        {
