namespace GL.Servers.HD.Files.CSV_Logic.Data
{
    ...
    internal class PieOvenGoodData : Data
    {
		/// <summary>
        /// Initializes a new instance of the <see cref="PieOvenGoodData"/> class.
        /// </summary>
        /// <param name="Row">The row.</param>
        /// <param name="DataTable">The data table.</param>
        public PieOvenGoodData(Row Row, DataTable DataTable) : base(Row, DataTable)
        {
