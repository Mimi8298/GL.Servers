namespace GL.Servers.HD.Files.CSV_Logic.Data
{
    ...
    internal class SmoothieMixerGoodData : Data
    {
		/// <summary>
        /// Initializes a new instance of the <see cref="SmoothieMixerGoodData"/> class.
        /// </summary>
        /// <param name="Row">The row.</param>
        /// <param name="DataTable">The data table.</param>
        public SmoothieMixerGoodData(Row Row, DataTable DataTable) : base(Row, DataTable)
        {
