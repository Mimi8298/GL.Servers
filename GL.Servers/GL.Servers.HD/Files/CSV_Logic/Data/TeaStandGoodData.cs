namespace GL.Servers.HD.Files.CSV_Logic.Data
{
    ...
    internal class TeaStandGoodData : Data
    {
		/// <summary>
        /// Initializes a new instance of the <see cref="TeaStandGoodData"/> class.
        /// </summary>
        /// <param name="Row">The row.</param>
        /// <param name="DataTable">The data table.</param>
        public TeaStandGoodData(Row Row, DataTable DataTable) : base(Row, DataTable)
        {
