namespace GL.Servers.HD.Files.CSV_Logic.Data
{
    ...
    internal class SauceMixerGoodData : Data
    {
		/// <summary>
        /// Initializes a new instance of the <see cref="SauceMixerGoodData"/> class.
        /// </summary>
        /// <param name="Row">The row.</param>
        /// <param name="DataTable">The data table.</param>
        public SauceMixerGoodData(Row Row, DataTable DataTable) : base(Row, DataTable)
        {
