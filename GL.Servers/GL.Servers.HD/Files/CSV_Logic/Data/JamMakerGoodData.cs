namespace GL.Servers.HD.Files.CSV_Logic.Data
{
    ...
    internal class JamMakerGoodData : Data
    {
		/// <summary>
        /// Initializes a new instance of the <see cref="JamMakerGoodData"/> class.
        /// </summary>
        /// <param name="Row">The row.</param>
        /// <param name="DataTable">The data table.</param>
        public JamMakerGoodData(Row Row, DataTable DataTable) : base(Row, DataTable)
        {
