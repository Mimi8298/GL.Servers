namespace GL.Servers.HD.Files.CSV_Logic.Data
{
    ...
    internal class PastaKitchenGoodData : Data
    {
		/// <summary>
        /// Initializes a new instance of the <see cref="PastaKitchenGoodData"/> class.
        /// </summary>
        /// <param name="Row">The row.</param>
        /// <param name="DataTable">The data table.</param>
        public PastaKitchenGoodData(Row Row, DataTable DataTable) : base(Row, DataTable)
        {
