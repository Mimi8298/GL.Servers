namespace GL.Servers.HD.Files.CSV_Logic.Data
{
    ...
    internal class BarbecueGrillGoodData : Data
    {
		/// <summary>
        /// Initializes a new instance of the <see cref="BarbecueGrillGoodData"/> class.
        /// </summary>
        /// <param name="Row">The row.</param>
        /// <param name="DataTable">The data table.</param>
        public BarbecueGrillGoodData(Row Row, DataTable DataTable) : base(Row, DataTable)
        {
