namespace GL.Servers.HD.Files.CSV_Logic.Data
{
    ...
    internal class SandwichBarGoodData : Data
    {
		/// <summary>
        /// Initializes a new instance of the <see cref="SandwichBarGoodData"/> class.
        /// </summary>
        /// <param name="Row">The row.</param>
        /// <param name="DataTable">The data table.</param>
        public SandwichBarGoodData(Row Row, DataTable DataTable) : base(Row, DataTable)
        {
