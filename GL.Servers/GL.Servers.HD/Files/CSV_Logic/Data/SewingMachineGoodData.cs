namespace GL.Servers.HD.Files.CSV_Logic.Data
{
    ...
    internal class SewingMachineGoodData : Data
    {
		/// <summary>
        /// Initializes a new instance of the <see cref="SewingMachineGoodData"/> class.
        /// </summary>
        /// <param name="Row">The row.</param>
        /// <param name="DataTable">The data table.</param>
        public SewingMachineGoodData(Row Row, DataTable DataTable) : base(Row, DataTable)
        {
