namespace GL.Servers.HD.Files.CSV_Logic.Data
{
    ...
    internal class CandleMakerGoodData : Data
    {
		/// <summary>
        /// Initializes a new instance of the <see cref="CandleMakerGoodData"/> class.
        /// </summary>
        /// <param name="Row">The row.</param>
        /// <param name="DataTable">The data table.</param>
        public CandleMakerGoodData(Row Row, DataTable DataTable) : base(Row, DataTable)
        {
