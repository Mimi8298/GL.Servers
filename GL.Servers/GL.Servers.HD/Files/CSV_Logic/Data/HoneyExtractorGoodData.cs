namespace GL.Servers.HD.Files.CSV_Logic.Data
{
    ...
    internal class HoneyExtractorGoodData : Data
    {
		/// <summary>
        /// Initializes a new instance of the <see cref="HoneyExtractorGoodData"/> class.
        /// </summary>
        /// <param name="Row">The row.</param>
        /// <param name="DataTable">The data table.</param>
        public HoneyExtractorGoodData(Row Row, DataTable DataTable) : base(Row, DataTable)
        {
