namespace GL.Servers.HD.Files.CSV_Logic.Data
{
    ...
    internal class BakeryGoodData : Data
    {
		/// <summary>
        /// Initializes a new instance of the <see cref="BakeryGoodData"/> class.
        /// </summary>
        /// <param name="Row">The row.</param>
        /// <param name="DataTable">The data table.</param>
        public BakeryGoodData(Row Row, DataTable DataTable) : base(Row, DataTable)
        {
