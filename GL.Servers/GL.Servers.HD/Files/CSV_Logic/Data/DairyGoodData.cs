namespace GL.Servers.HD.Files.CSV_Logic.Data
{
    ...
    internal class DairyGoodData : Data
    {
		/// <summary>
        /// Initializes a new instance of the <see cref="DairyGoodData"/> class.
        /// </summary>
        /// <param name="Row">The row.</param>
        /// <param name="DataTable">The data table.</param>
        public DairyGoodData(Row Row, DataTable DataTable) : base(Row, DataTable)
        {
