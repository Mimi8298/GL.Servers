namespace GL.Servers.HD.Files.CSV_Logic.Data
{
    ...
    internal class PastaMakerGoodData : Data
    {
		/// <summary>
        /// Initializes a new instance of the <see cref="PastaMakerGoodData"/> class.
        /// </summary>
        /// <param name="Row">The row.</param>
        /// <param name="DataTable">The data table.</param>
        public PastaMakerGoodData(Row Row, DataTable DataTable) : base(Row, DataTable)
        {
