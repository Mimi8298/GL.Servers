namespace GL.Servers.HD.Files.CSV_Logic.Data
{
    ...
    internal class CandyMachineGoodData : Data
    {
		/// <summary>
        /// Initializes a new instance of the <see cref="CandyMachineGoodData"/> class.
        /// </summary>
        /// <param name="Row">The row.</param>
        /// <param name="DataTable">The data table.</param>
        public CandyMachineGoodData(Row Row, DataTable DataTable) : base(Row, DataTable)
        {
