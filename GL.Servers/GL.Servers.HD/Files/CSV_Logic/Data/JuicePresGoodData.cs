namespace GL.Servers.HD.Files.CSV_Logic.Data
{
    ...
    internal class JuicePresGoodData : Data
    {
		/// <summary>
        /// Initializes a new instance of the <see cref="JuicePresGoodData"/> class.
        /// </summary>
        /// <param name="Row">The row.</param>
        /// <param name="DataTable">The data table.</param>
        public JuicePresGoodData(Row Row, DataTable DataTable) : base(Row, DataTable)
        {
