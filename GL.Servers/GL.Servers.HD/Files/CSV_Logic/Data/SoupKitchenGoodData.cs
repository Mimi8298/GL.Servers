namespace GL.Servers.HD.Files.CSV_Logic.Data
{
    ...
    internal class SoupKitchenGoodData : Data
    {
		/// <summary>
        /// Initializes a new instance of the <see cref="SoupKitchenGoodData"/> class.
        /// </summary>
        /// <param name="Row">The row.</param>
        /// <param name="DataTable">The data table.</param>
        public SoupKitchenGoodData(Row Row, DataTable DataTable) : base(Row, DataTable)
        {
