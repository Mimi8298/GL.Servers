namespace GL.Servers.HD.Files.CSV_Logic.Data
{
    ...
    internal class SushiBarGoodData : Data
    {
		/// <summary>
        /// Initializes a new instance of the <see cref="SushiBarGoodData"/> class.
        /// </summary>
        /// <param name="Row">The row.</param>
        /// <param name="DataTable">The data table.</param>
        public SushiBarGoodData(Row Row, DataTable DataTable) : base(Row, DataTable)
        {
