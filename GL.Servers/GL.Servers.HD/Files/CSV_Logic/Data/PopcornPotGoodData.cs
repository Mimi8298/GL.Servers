namespace GL.Servers.HD.Files.CSV_Logic.Data
{
    ...
    internal class PopcornPotGoodData : Data
    {
		/// <summary>
        /// Initializes a new instance of the <see cref="PopcornPotGoodData"/> class.
        /// </summary>
        /// <param name="Row">The row.</param>
        /// <param name="DataTable">The data table.</param>
        public PopcornPotGoodData(Row Row, DataTable DataTable) : base(Row, DataTable)
        {
