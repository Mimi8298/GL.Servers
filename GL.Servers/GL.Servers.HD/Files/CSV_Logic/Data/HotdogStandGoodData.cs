namespace GL.Servers.HD.Files.CSV_Logic.Data
{
    ...
    internal class HotdogStandGoodData : Data
    {
		/// <summary>
        /// Initializes a new instance of the <see cref="HotdogStandGoodData"/> class.
        /// </summary>
        /// <param name="Row">The row.</param>
        /// <param name="DataTable">The data table.</param>
        public HotdogStandGoodData(Row Row, DataTable DataTable) : base(Row, DataTable)
        {
