namespace GL.Servers.HD.Files.CSV_Logic.Data
{
    ...
    internal class WarehouseData : Data
    {
		/// <summary>
        /// Initializes a new instance of the <see cref="WarehouseData"/> class.
        /// </summary>
        /// <param name="Row">The row.</param>
        /// <param name="DataTable">The data table.</param>
        public WarehouseData(Row Row, DataTable DataTable) : base(Row, DataTable)
        {
