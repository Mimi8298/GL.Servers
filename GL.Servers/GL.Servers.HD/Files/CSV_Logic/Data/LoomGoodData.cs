namespace GL.Servers.HD.Files.CSV_Logic.Data
{
    ...
    internal class LoomGoodData : Data
    {
		/// <summary>
        /// Initializes a new instance of the <see cref="LoomGoodData"/> class.
        /// </summary>
        /// <param name="Row">The row.</param>
        /// <param name="DataTable">The data table.</param>
        public LoomGoodData(Row Row, DataTable DataTable) : base(Row, DataTable)
        {
