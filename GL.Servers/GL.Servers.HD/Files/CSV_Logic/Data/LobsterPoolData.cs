namespace GL.Servers.HD.Files.CSV_Logic.Data
{
    ...
    internal class LobsterPoolData : Data
    {
		/// <summary>
        /// Initializes a new instance of the <see cref="LobsterPoolData"/> class.
        /// </summary>
        /// <param name="Row">The row.</param>
        /// <param name="DataTable">The data table.</param>
        public LobsterPoolData(Row Row, DataTable DataTable) : base(Row, DataTable)
        {
