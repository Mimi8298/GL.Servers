namespace GL.Servers.HD.Files.CSV_Logic.Data
{
    ...
    internal class SmelterGoodData : Data
    {
		/// <summary>
        /// Initializes a new instance of the <see cref="SmelterGoodData"/> class.
        /// </summary>
        /// <param name="Row">The row.</param>
        /// <param name="DataTable">The data table.</param>
        public SmelterGoodData(Row Row, DataTable DataTable) : base(Row, DataTable)
        {
