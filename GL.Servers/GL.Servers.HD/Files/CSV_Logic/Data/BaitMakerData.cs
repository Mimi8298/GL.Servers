namespace GL.Servers.HD.Files.CSV_Logic.Data
{
    ...
    internal class BaitMakerData : Data
    {
		/// <summary>
        /// Initializes a new instance of the <see cref="BaitMakerData"/> class.
        /// </summary>
        /// <param name="Row">The row.</param>
        /// <param name="DataTable">The data table.</param>
        public BaitMakerData(Row Row, DataTable DataTable) : base(Row, DataTable)
        {
