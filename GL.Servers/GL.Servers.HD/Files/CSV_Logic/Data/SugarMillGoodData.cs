namespace GL.Servers.HD.Files.CSV_Logic.Data
{
    ...
    internal class SugarMillGoodData : Data
    {
		/// <summary>
        /// Initializes a new instance of the <see cref="SugarMillGoodData"/> class.
        /// </summary>
        /// <param name="Row">The row.</param>
        /// <param name="DataTable">The data table.</param>
        public SugarMillGoodData(Row Row, DataTable DataTable) : base(Row, DataTable)
        {
