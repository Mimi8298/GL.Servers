namespace GL.Servers.HD.Files.CSV_Logic.Data
{
    ...
    internal class ProcessingBuildingData : Data
    {
		/// <summary>
        /// Initializes a new instance of the <see cref="ProcessingBuildingData"/> class.
        /// </summary>
        /// <param name="Row">The row.</param>
        /// <param name="DataTable">The data table.</param>
        public ProcessingBuildingData(Row Row, DataTable DataTable) : base(Row, DataTable)
        {
