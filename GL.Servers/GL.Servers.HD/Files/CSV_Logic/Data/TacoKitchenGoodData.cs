namespace GL.Servers.HD.Files.CSV_Logic.Data
{
    ...
    internal class TacoKitchenGoodData : Data
    {
		/// <summary>
        /// Initializes a new instance of the <see cref="TacoKitchenGoodData"/> class.
        /// </summary>
        /// <param name="Row">The row.</param>
        /// <param name="DataTable">The data table.</param>
        public TacoKitchenGoodData(Row Row, DataTable DataTable) : base(Row, DataTable)
        {
