namespace GL.Servers.HD.Files.CSV_Logic.Data
{
    ...
    internal class CafeGoodData : Data
    {
		/// <summary>
        /// Initializes a new instance of the <see cref="CafeGoodData"/> class.
        /// </summary>
        /// <param name="Row">The row.</param>
        /// <param name="DataTable">The data table.</param>
        public CafeGoodData(Row Row, DataTable DataTable) : base(Row, DataTable)
        {
