namespace GL.Servers.HD.Files.CSV_Logic.Data
{
    ...
    internal class IceCreamMakerGoodData : Data
    {
		/// <summary>
        /// Initializes a new instance of the <see cref="IceCreamMakerGoodData"/> class.
        /// </summary>
        /// <param name="Row">The row.</param>
        /// <param name="DataTable">The data table.</param>
        public IceCreamMakerGoodData(Row Row, DataTable DataTable) : base(Row, DataTable)
        {
