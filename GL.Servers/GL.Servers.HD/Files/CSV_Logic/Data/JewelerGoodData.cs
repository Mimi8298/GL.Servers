namespace GL.Servers.HD.Files.CSV_Logic.Data
{
    ...
    internal class JewelerGoodData : Data
    {
		/// <summary>
        /// Initializes a new instance of the <see cref="JewelerGoodData"/> class.
        /// </summary>
        /// <param name="Row">The row.</param>
        /// <param name="DataTable">The data table.</param>
        public JewelerGoodData(Row Row, DataTable DataTable) : base(Row, DataTable)
        {
