namespace GL.Servers.HD.Files.CSV_Logic.Data
{
    ...
    internal class HatMakerGoodData : Data
    {
		/// <summary>
        /// Initializes a new instance of the <see cref="HatMakerGoodData"/> class.
        /// </summary>
        /// <param name="Row">The row.</param>
        /// <param name="DataTable">The data table.</param>
        public HatMakerGoodData(Row Row, DataTable DataTable) : base(Row, DataTable)
        {
