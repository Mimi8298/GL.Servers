namespace GL.Servers.CoC.Packets.Messages.Server.Avatar
{
    ...
    internal class Avatar_Stream_Entry_Message : Message
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Avatar_Stream_Entry_Message"/> class.
        /// </summary>
        /// <param name="Device">The device.</param>
        public Avatar_Stream_Entry_Message(Device Device, AvatarStreamEntry StreamEntry) : base (Device)
        {
        ...
        {
            this.Data.AddInt(this.StreamEntry.Type);
