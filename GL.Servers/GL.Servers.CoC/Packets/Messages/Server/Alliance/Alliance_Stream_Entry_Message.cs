namespace GL.Servers.CoC.Packets.Messages.Server.Alliance
{
    ...
    internal class Alliance_Stream_Entry_Message : Message
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Alliance_Stream_Entry_Message"/> class.
        /// </summary>
        /// <param name="Device">The device.</param>
        public Alliance_Stream_Entry_Message(Device Device, StreamEntry StreamEntry) : base(Device)
        {
        ...
        {
            this.Data.AddInt((int) this.StreamEntry.StreamType);
