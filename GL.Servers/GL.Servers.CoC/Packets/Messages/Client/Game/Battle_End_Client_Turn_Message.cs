namespace GL.Servers.CoC.Packets.Messages.Client.Game
{
    ...
    internal class Battle_End_Client_Turn_Message : Message
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Battle_End_Client_Turn_Message"/> class.
        /// </summary>
        /// <param name="Device">The device.</param>
        /// <param name="Reader">The reader.</param>
        public Battle_End_Client_Turn_Message(Device Device, Reader Reader) : base(Device, Reader)
        {
            // Battle_End_Client_Turn_Message.
        }
