namespace GL.Tools.Intruder.Extensions.Binary
{
    ...
    {
        internal Reader(byte[] _Buffer) : base(new MemoryStream(_Buffer))
        {
            // Packet Reader...
        }
        ...
        public override bool ReadBoolean()
        {
            ...
            switch (state)
            {
                ...
                default:
                    throw new NotSupportedException("Attempted to read a byte [" + state + "] and convert it to boolean, but is out of boolean range.");
            }
        }
