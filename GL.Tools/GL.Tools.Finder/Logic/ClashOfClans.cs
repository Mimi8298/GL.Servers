namespace GL.Tools.Finder.Logic
{
    ...
    internal class ClashOfClans : Supercell
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ClashOfClans"/> class.
        /// </summary>
        internal ClashOfClans()
        {
        ...
        internal ClashOfClans(long Offset) : this()
        {
            this.Offset = Offset;
        }
        ...
        public void Patch(byte[] File)
        {
            if (Console.ReadKey(false).Key == ConsoleKey.Y)
            {
                ...
                using (FileStream FStream = System.IO.File.Create(Directory.GetCurrentDirectory() + "\\Patched\\" + "CoC-libg.so", Patched.Count, FileOptions.None))
                {
